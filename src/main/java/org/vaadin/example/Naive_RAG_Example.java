...
public class Naive_RAG_Example {
    ...
    public static void main(String[] args) {
        ...
        // Let's create an assistant that will know about our content
        Assistant assistant = createAssistant("src/main/resources/docs/title-29.json");
    ...
    private static Assistant createAssistant(String documentPath) {
        ...
        // A good starting  point is to use a recursive document splitter that initially attemps
        ...
        // This store wil be used to search for relevant segments during each interaction with the LLM.
        ...
        // We could also use EmbeddingStoreIngestor to hid manual steps above behind a simpler API.
        ...
        // Currently, LangChain4j offers two chat memmory implementations:
        // MessageWindowChatMemory and TokenWindowChatMemory.
        ChatMemory chatMemory = MessageWindowChatMemory.withMaxMessages(10);

        // The final step is to build our API Service
